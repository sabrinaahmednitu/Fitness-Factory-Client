...
const ImageGallery = () => {
  ...
  return (
    <div>
      ...
      <div className="container grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1 auto-rows-min">
